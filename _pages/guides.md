...
* [Download and Install Gradle on Windows]({{ site.url }}/download-install-gradle-windows.html)
...
* [Download and Install JDK 9 on Windows]({{ site.url }}/download-install-jdk-9-windows.html)
...
* [Download and Install Apache Maven on Windows]({{ site.url }}/download-install-apache-maven-windows.html)
