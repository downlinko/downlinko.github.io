...
> Do you want to skip the above steps? Here is the direct link to download the [Maven 3.2.2 binary](https://archive.apache.org/dist/maven/maven-3/3.2.2/binaries/apache-maven-3.2.2-bin.zip){:target="_blank"} for Windows.
